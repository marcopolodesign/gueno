...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-168562015-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-168562015-1');
</script>
...
})(window,document,'script','dataLayer','GTM-59Q97PG');</script>
<!-- End Google Tag Manager -->

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-59Q97PG"
